...
Для анонса второго, тестового маршрута, необходимо добавить в анонсы статическую маршрутизацию. Добавляем анонсы в настройки VRF процесса BGP. 
Итог в файле: spine-1_route.cfg

### Cumulus

В данном случае, команды настройки фильтрации, совершенно одинаковые для обоих вендоров, за исключением того, что роут-мап на Aricte "вешается" на основной процесс BGP, что не логично. У Cumulus это делается в настройках VRF.
